...
export function WidgetLauncher(props: { onClick: () => void }) {
  ...
  return (
    <Tooltip 
      title="Ask AutoTractor - Your TSC AI Assistant" 
      placement="top"
      arrow
      PopperProps={{
        sx: {
    ...
    >
      ...
      >
        <IconButton
          ...
          aria-label="Open TSC AI Assistant"
          sx={{
            width: 64,
            height: 64,
            borderRadius: '50%',
            ...
            boxShadow: isHovered 
              ? '0 12px 40px rgba(200, 16, 46, 0.4), 0 4px 12px rgba(0,0,0,0.15)'
              : '0 6px 24px rgba(200, 16, 46, 0.25), 0 2px 8px rgba(0,0,0,0.1)',
            '&:hover': {
              background: `linear-gradient(135deg, #d91e3a 0%, #c8102e 100%)`,
            },
            '&:before': {
              content: '""',
              position: 'absolute',
