    ...
    <Fade in timeout={300}>
      <Paper
        ...
        sx={{
          ...
          boxShadow: theme.palette.mode === 'dark'
            ? '0 24px 64px rgba(0, 0, 0, 0.4), 0 8px 32px rgba(200, 16, 46, 0.15)'
            : '0 24px 64px rgba(0, 0, 0, 0.12), 0 8px 32px rgba(200, 16, 46, 0.08)',
          zIndex: 1300,
          overflow: 'hidden',
          display: 'flex',
      ...
      >
        ...
        <Box sx={{ 
          ...
          background: theme.palette.mode === 'dark'
            ? 'linear-gradient(135deg, rgba(200, 16, 46, 0.15) 0%, rgba(200, 16, 46, 0.05) 100%)'
            : 'linear-gradient(135deg, rgba(200, 16, 46, 0.05) 0%, rgba(200, 16, 46, 0.02) 100%)',
